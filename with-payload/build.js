...
exports.genericActionCreator = exports.genericActionType = exports.actionCreator = exports.actionBuilder = undefined;

var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var _zipObj = __webpack_require__(39);
...
var _nthArg = __webpack_require__(32);

var _nthArg2 = _interopRequireDefault(_nthArg);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var actionBuilder = exports.actionBuilder = function actionBuilder(compose) {
    var generic = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    ...
    return function (type) {
        ...
        var waitValues = function waitValues(type) {
            return function () {
                for (var _len2 = arguments.length, values = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
                    values[_key2] = arguments[_key2];
                }

                return compose({ type: type }, (0, _zipObj2.default)(argNames, values));
            };
        };
        if (generic) {
 ...
 */
var actionCreator = exports.actionCreator = actionBuilder(composeAction);
 ...
 */
var genericActionType = exports.genericActionType = (0, _ifElse2.default)((0, _compose2.default)(_isEmpty2.default, (0, _nthArg2.default)(0)), (0, _nthArg2.default)(1), function (genericType, actionType) {
    return genericType + '_' + actionType;
});
 ...
 * @param argNames
 */
var genericActionCreator = exports.genericActionCreator = actionBuilder(composeAction, true);
...
var reverse = __webpack_require__(35);
...
var _curry1 = __webpack_require__(0);
var _isArguments = __webpack_require__(11);
var _isArray = __webpack_require__(7);
...
var _curry3 = __webpack_require__(5);
...
var _arrayFromIterator = __webpack_require__(20);
var _functionName = __webpack_require__(23);
var _has = __webpack_require__(6);
var identical = __webpack_require__(18);
...
var _curry1 = __webpack_require__(0);
var empty = __webpack_require__(16);
...
var tail = __webpack_require__(37);
